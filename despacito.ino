...
void chorus(){
     ...
     note(keytime, NOTE_CS5);digitalWrite(led, HIGH);   // (1)
...
//......
     ...
     note(keytime/4, NOTE_D5);          
     note(keytime/4, NOTE_CS5);               
     note(keytime/4, NOTE_D5);digitalWrite(led, LOW);              
     note(keytime/4, NOTE_CS5);digitalWrite(led, HIGH);            
     note(keytime/2, NOTE_D5);digitalWrite(led, LOW);    
